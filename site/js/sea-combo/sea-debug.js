...
;(function(seajs, util, config) {
  ...
  Module.prototype._use = function(ids, callback) {
	...
	console.log('_use',uris);
    this._load(uris, function() {//console.log('_load',uris);
  ...
  Module.prototype._load = function(uris, callback) {//console.log('seajs load');
...
console.log('onfetched:',uri,module.status);
    ...
    function cb(module) {
      ...
      --remain === 0 && (console.log('--load callback',uris),callback());
    }
  }
...
console.log(id, module.uri,uri,child);
  ...
  Module._define = function(id, deps, factory) {console.log('seajs define');
